                  ...
                  <div className="grid w-full grid-cols-1 lg:grid-cols-2 md:grid-cols-1 gap-7 mt-7 ">
                    <div>
                      ...
                      <div className="relative top-1  ">
                        ...
                        {/* Start of type dish */}
                        <div className="py-4">
                          <p className="text-base font-medium leading-none text-gray-800">Diet Type</p>
                          <div className="relative w-full mt-2 border border-gray-300 rounded outline-none dropdown-one">
                            <button onClick={showDropDownMenu} className="relative flex items-center justify-between w-full px-5 py-4 dropbtn-one">
                    ...
                    <div>
                      ...
                      <div className="py-4">
                        <p className="text-base font-medium leading-none text-gray-800 pb">Type of Dish</p>
                        {/*-Dropdown*/}
                        <div className="relative top-1 ">
                          <div className="relative w-full mt-2 border border-gray-300 rounded outline-none dropdown-one">
                    ...
                    <div>
                      ...
                      <input type='text' className="w-full p-3 mt-4 border border-gray-300 rounded outline-none focus:bg-gray-50" id="includeIngredient" />
                    ...
                    <div>
                      ...
                      <input type='text' className="w-full p-3 mt-4 border border-gray-300 rounded outline-none focus:bg-gray-50" id="excludeIngredient"/>
